...
const buttonVariants = cva(
  "inline-flex justify-center items-center gap-2 disabled:opacity-50 focus-visible:border-slate-950 dark:focus-visible:border-slate-300 aria-invalid:border-red-500 dark:aria-invalid:border-red-900 rounded-md outline-none aria-invalid:ring-red-500/20 focus-visible:ring-[3px] focus-visible:ring-slate-950/50 dark:aria-invalid:ring-red-500/40 dark:aria-invalid:ring-red-900/20 dark:focus-visible:ring-slate-300/50 dark:dark:aria-invalid:ring-red-900/40 [&_svg:not([class*='size-'])]:size-4 font-medium text-sm whitespace-nowrap transition-all [&_svg]:pointer-events-none disabled:pointer-events-none shrink-0 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
